package me.spartann.foodplus.common.blocks.crops;
...
public class HopBlock extends CropsBlock implements ILootTableMultiDropsData {
    ...
    public NonNullList<Item> getDrops() {
        return NonNullList.from(null, ModItems.HOP_SEED.get(), ModItems.HOP_SEED.get());
    }
