...
import com.spartann.foodplus.common.recipe.serializer.ShapedSandwichSerializer;
...
public class ModRecipeTypes {
    ...
    public static final RegistryObject<ShapedSandwichSerializer> SHAPED_SANDWICH_SERIALIZER = SERIALIZERS.register(ISandwichMakerRecipe.TYPE_ID.getPath(), ShapedSandwichSerializer::new);
    ...
    public static final IRecipeType<ISandwichMakerRecipe> SHAPED_SANDWICH_RECIPE_TYPE = registerType(ISandwichMakerRecipe.TYPE_ID);
