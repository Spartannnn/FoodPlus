...
public class ItemHarvesterTool extends ToolItem {

    public ItemHarvesterTool(Properties builder) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextComponentUtil.stringTextComponent("Use this tool to harvest the fruits", TextFormatting.GRAY));
    }
