...
public abstract class TileRecipe<R extends IModRecipe<RecipeWrapper>> extends TileContainer implements ITickableTileEntity {
    ...
    public TileRecipe(TileEntityType<?> tileEntityTypeIn, int inventorySlots) {
