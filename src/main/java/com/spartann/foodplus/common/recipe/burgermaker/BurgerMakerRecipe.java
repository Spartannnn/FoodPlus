...
public class BurgerMakerRecipe implements IBurgerMakerRecipe{
    ...
    public BurgerMakerRecipe(ResourceLocation id, Ingredient[] inputs, ItemStack output, int secondsUntilFinish) {
        this.id = id;
        this.output = output;
        this.inputs = inputs;
    ...
    public IRecipeSerializer<?> getSerializer() {
        return ModRecipeTypes.BURGER_MAKER_SERIALIZER.get();
    }
