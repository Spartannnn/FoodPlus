...
public class BlockBeerBewer extends BlockContainer<TileBeerBrewer> {
    ...
    public BlockBeerBewer(Properties properties) {
        super(properties);
    }
    ...
    @Override
    public Class<TileBeerBrewer> tileEntityClass() {
        return TileBeerBrewer.class;
    }
