...
public class BlockStateDataGen extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        this.axisBlock((RotatedPillarBlock) ModBlocks.BANANA_LOG.get(), getTexture(ModBlocks.BANANA_LOG), getExtendedTexture(ModBlocks.BANANA_LOG, "_top"));
        ...
        this.simpleBlock(ModBlocks.BANANA_LEAVES.get(), models().getExistingFile(getModelPath(ModBlocks.BANANA_LEAVES)));
        ...
        this.simpleBlock(ModBlocks.BANANA_SAPLING.get(), models().getExistingFile(getModelPath(ModBlocks.BANANA_SAPLING)));
