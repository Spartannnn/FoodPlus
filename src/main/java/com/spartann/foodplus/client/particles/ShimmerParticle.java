package com.spartann.foodplus.client.particles;

import com.spartann.foodplus.client.particles.data.ScaledColoredParticleData;
import com.spartann.foodplus.common.registries.ModParticleRenderTypes;
...
public class ShimmerParticle extends SpriteTexturedParticle {
    ...
    public static IParticleData getData(boolean show, int color, float scale) {
        return new ScaledColoredParticleData(ModParticleTypes.SHIMMER, show, color, scale);
    }
